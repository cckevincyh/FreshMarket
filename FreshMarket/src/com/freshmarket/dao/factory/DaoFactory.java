...
import com.freshmarket.dao.AdminDao;
import com.freshmarket.dao.CommodityDao;
import com.freshmarket.dao.CommodityTypeDao;
...
public class DaoFactory {
	...
	public static AdminDao getAdminDao(){
		//得到dao实现类的名称
		String daoClassName = props.getProperty("com.freshmarket.dao.AdminDao");
	...
	public static CommodityTypeDao getCommodityTypeDao(){
		//得到dao实现类的名称
		String daoClassName = props.getProperty("com.freshmarket.dao.CommodityTypeDao");
	...
	public static CommodityDao getCommodityDao(){
		//得到dao实现类的名称
		String daoClassName = props.getProperty("com.freshmarket.dao.CommodityDao");
