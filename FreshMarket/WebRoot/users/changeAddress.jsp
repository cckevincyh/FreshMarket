...
<br><p align="center">&nbsp;</p>
<div id="formbox">
	<form id="formpersonal" method="post" action="<c:url value='/UserServlet?method=changeAddress'/>">
	<div class="form">
		<h3>收货地址</h3>
  ...
  <div class="item">
		    ...
		    <div class="fl">
		    	<input type="hidden" value="${sessionUser.username }" name="username"/>
				<input type="text" value="${sessionUser.address }" name="address" class="text" tabindex="12" />
