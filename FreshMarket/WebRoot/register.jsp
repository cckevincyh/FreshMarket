			  ...
			  <ul class="right-form">
			    <h2>注册:</h2>
					<div>
					  ...
					  <li> <input type="password" name="password" value="${registerForm.password }" placeholder="请输入密码" required/>
					  </li>
                      
                      <span style="color:#F00">${errors.userpassword }</span>
                      
                      
                      <li><input type="password" name="password2"  value="${registerForm.password2 }"  placeholder="请输入确认密码"  required"/>
